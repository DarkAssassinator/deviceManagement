...
import com.yann.device.common.Constants.UserConstants;
import com.yann.device.mapper.SysMenuMapper;
import com.yann.device.mapper.SysRoleMenuMapper;
import com.yann.device.pojo.SysMenu;
import com.yann.device.pojo.SysRole;
import com.yann.device.pojo.SysUser;
import com.yann.device.pojo.Ztree;
import com.yann.device.service.ISysMenuService;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<SysMenu> selectMenusByUser(SysUser user) {
        List<SysMenu> menus;
        // 管理员显示所有菜单信息
        menus = user.isAdmin() ? menuMapper.selectMenuNormalAll() : menuMapper.selectMenusByUserId(user.getUserId());
    ...
    public List<SysMenu> selectMenuAll(Long userId) {
        return SysUser.isAdmin(userId) ? menuMapper.selectMenuAll() : menuMapper.selectMenuAllByUserId(userId);
    }
